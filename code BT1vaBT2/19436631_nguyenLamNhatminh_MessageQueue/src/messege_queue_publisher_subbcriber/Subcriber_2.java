...
public class Subcriber_2 extends JFrame {
	...
	public static void main(String[] args) throws Exception {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Subcriber_2 frame = new Subcriber_2();
	...
	public Subcriber_2() throws JMSException, NamingException {
		setTitle("Người đăng ký 2 của Lâm Nhật Minh");
