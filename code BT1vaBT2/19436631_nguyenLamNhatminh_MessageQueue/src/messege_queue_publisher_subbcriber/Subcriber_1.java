...
public class Subcriber_1 extends JFrame {
	...
	public static void main(String[] args) throws Exception {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Subcriber_1 frame = new Subcriber_1();
	...
	public Subcriber_1() throws JMSException, NamingException {
		setTitle("Người đăng ký 1 của Lâm Nhật Minh");
